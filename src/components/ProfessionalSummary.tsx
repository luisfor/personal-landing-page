    ...
    return (
        <section className="py-20 bg-white">
            <div className="container mx-auto px-6">
                ...
                {/* Micro-headline Nivel Dios */}
                <p className="text-center text-lg md:text-xl text-slate-600 mb-12 max-w-2xl mx-auto font-medium">
                    Especialista en infraestructuras cloud seguras y de alta disponibilidad.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    {/* Block 1: Estudios y Certificaciones */}
                    <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 hover-premium-card">
                        ...
                        <div className="space-y-6">
                            <div className="relative pl-6 border-l-2 border-slate-200">
                                ...
                                <p className="text-sm text-slate-600 mb-1">Fundación Universitaria Tecnológico de Comfenalco</p>
                                <p className="text-xs text-slate-500 italic">Base sólida en arquitectura de software y redes.</p>
                            </div>

                            <div className="relative pl-6 border-l-2 border-slate-200">
                                <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-blue-500 ring-4 ring-white"></div>
                                <h4 className="font-bold text-slate-900">Especialización en Gestión de BBDD</h4>
                                <p className="text-sm text-slate-600 mb-1">SENA</p>
                                <p className="text-xs text-slate-500 italic">Diseño para alta disponibilidad y resiliencia.</p>
                            </div>
                            ...
                            <div className="relative pl-6 border-l-2 border-slate-200">
                                ...
                                <p className="text-sm text-slate-600 mb-1">BSG Institute</p>
                                <p className="text-xs text-[#00b4d9] font-medium">→ Administración y optimización de entornos productivos.</p>
                            </div>

                            <div className="relative pl-6 border-l-2 border-slate-200">
                                <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-orange-500 ring-4 ring-white"></div>
                                <h4 className="font-bold text-slate-900">Google Workspace Admin</h4>
                                <p className="text-sm text-slate-600 mb-1">Certificación Profesional de Google</p>
                                <p className="text-xs text-[#00b4d9] font-medium">→ Unificación de identidades y seguridad colaborativa.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 hover-premium-card">
                        ...
                        <div className="space-y-4">
                            <RoadmapItem
                                ...
                                description="Mejorando fluidez técnica B1 → C1."
                                progress={65}
                                color="bg-purple-500"
                            />
                            <RoadmapItem
                                title="Python & AI Development"
                                status="En especialización"
                            ...
                            <RoadmapItem
                                ...
                                description="Estandarización de workflows y orquestación."
                                progress={30}
                                color="bg-amber-500"
                            />
                        </div>
